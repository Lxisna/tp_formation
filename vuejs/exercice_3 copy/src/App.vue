...
export default {
      ...
      navItemsArray: [
        {
          ...
          link: "#",
          target: "_self",
          emit: [{ event: "updatePage", value: { EditPage: true } }],
          class: "link-body-emphasis",
        },
        {
          name: "Preview",
          link: "#",
          emit: [{ event: "updatePage", value: { PreviewPage: true } }],
          target: "_self",
          class: "link-body-emphasis",
        },
        {
          name: "Settings",
          link: "#",
          emit: [{ event: "updatePage", value: { settingsPage: true } }],
          target: "_self",
          class: "link-body-emphasis",
        },
      ],
  ...
  methods: {
    ...
    toggleMenu() {
      this.showUserNav = this.showUserNav ? false : true;
    },
  },
};
</script>
...
<template>
  <main-layout>
    ...
    <template #header>
      ...
      <button class="btn btn-success" @click="toggleMenu">Button</button>
      <!-- un bouton -->
      <!-- l'event click -->
    ...
    <section class="d-flex wrap">
      ...
      <products-table class="col-6" :products="products" />
    </section>
